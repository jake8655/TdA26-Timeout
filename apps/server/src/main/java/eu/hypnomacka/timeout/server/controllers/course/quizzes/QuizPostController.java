...
public class QuizPostController extends Controller {
    ...
    public ResponseEntity<?> createQuiz(
        ...
        if (request.getTitle() == null || request.getTitle().isBlank()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                Map.of("message", "title is required")
            );
        }
        ...
        if (request.getQuestions() == null) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                Map.of("message", "questions are required")
            );
        }
        ...
        for (Object questionObj : request.getQuestions()) {
            ...
            question.setType(type.equals("singleChoice") ? Question.Type.singleChoice : Question.Type.multipleChoice);
