...
public class DatabaseSeeder {
  ...
  private void createCourse1(Lecturer lecturer) {
    Course course = new Course(lecturer, "Introduction to Programming", "Learn the fundamentals of programming with hands-on examples and exercises.");
    course.save();
  ...
  private void createMaterials1(Course course) {
    ...
    UrlAttachment url1 = new UrlAttachment(
        course,
  ...
  private void createPosts1(Course course) {
    ...
    post1.setMessage("Welcome to Introduction to Programming! Please review the syllabus and introduce yourself in the discussion forum.");
    post1.save();

    Event post2 = new Event();
    post2.setCourse(course);
    post2.setType(Event.Type.MANUAL);
    post2.setMessage("Assignment 1 has been posted. Due date: next Friday. Remember to submit through the portal.");
    post2.save();
  }
  ...
  private void createCourse2(Lecturer lecturer) {
    Course course = new Course(lecturer, "Data Structures", "Master essential data structures including arrays, linked lists, trees, and graphs.");
    course.save();
  ...
  private void createMaterials2(Course course) {
    ...
    UrlAttachment url2 = new UrlAttachment(
        course,
        "Practice Problems",
  ...
  private void createPosts2(Course course) {
    ...
    post1.setCourse(course);
    post1.setType(Event.Type.MANUAL);
    post1.setMessage("This week we dive into linked lists. Check the materials section for implementation examples.");
    post1.save();

    Event post2 = new Event();
    post2.setCourse(course);
    post2.setType(Event.Type.MANUAL);
    post2.setMessage("Midterm exam scheduled for Week 8. Topics: Arrays, Linked Lists, Stacks, and Queues.");
    post2.save();
  ...
  private void createCourse3(Lecturer lecturer) {
    Course course = new Course(lecturer, "Web Development", "Build modern web applications using HTML, CSS, JavaScript, and popular frameworks.");
    course.save();
  ...
  private void createPosts3(Course course) {
    ...
    post1.setCourse(course);
    post1.setType(Event.Type.MANUAL);
    post1.setMessage("Welcome to Web Development! We'll start with HTML basics this week. Please have your code editor ready.");
    post1.save();

    Event post2 = new Event();
    post2.setCourse(course);
    post2.setType(Event.Type.MANUAL);
    post2.setMessage("Project 1: Personal Portfolio Website. Requirements are now available in the materials section.");
    post2.save();
  }
  ...
  private void createQuiz3(Course course) {
    ...
    q3.setOptions(List.of("Inline style attribute", "<link> tag", "<css> tag", "@import", "<style> tag"));
