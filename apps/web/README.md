...
The application is deployed using [Docker](https://docker.com) to ~~[TdA Cloud](https://tourde.cloud)~~ a VPS. ~Pushes to the `main` branch trigger (semi-)automatic deployments.~
